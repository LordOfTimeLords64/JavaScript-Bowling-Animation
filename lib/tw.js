...
TW.setKeyboardCallback("1",TW.toggleAxes,"toggle axes",true);
TW.setKeyboardCallback("2",TW.toggleBoundingBox,"toggle scene bounding box",true);
TW.setKeyboardCallback("3",TW.toggleGroundPlane,"toggle ground plane",true);
TW.setKeyboardCallback("4",TW.viewFromSide, "view from side (+X)",true);
TW.setKeyboardCallback("5",TW.viewFromAbove,"view from above (+Y)",true);
TW.setKeyboardCallback("6",TW.viewFromFront,"view from front (+Z)",true);
TW.setKeyboardCallback("7",TW.viewFromAboveFrontSide,"view obliquely, from above front side (+XYZ)",true);
